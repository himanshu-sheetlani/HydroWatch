    ...
    <section ref={container} className="py-24 px-6 relative">
      <div className="max-w-6xl mx-auto">
        <div className="section-header text-center mb-16 space-y-4">
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight">Intelligence in real-time</h2>
        ...
        <div className="dashboard-container relative group">
          ...
          <div className="absolute -inset-1 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-[2.5rem] blur-2xl opacity-50 group-hover:opacity-100 transition duration-1000"></div>
          
          <div className="relative bg-black/4 backdrop-blur-3xl border border-white/10 rounded-[2.5rem] overflow-hidden shadow-2xl">
            {/* Dashboard Header */}
