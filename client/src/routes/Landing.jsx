...
import { ChevronRight, Droplets, Shield, Activity, Database, Wind, Zap, Mail, Lock, Archive, Trash2, Cloud, Server } from "lucide-react";
...
export default function HydroWatchLanding() {
    ...
    cards.forEach(card => {
      card.addEventListener("mouseenter", () => {
        gsap.to(card, {
          ...
          boxShadow: "0 20px 40px rgba(0, 0, 0, 0.4), 0 0 20px rgba(34, 211, 238, 0.1)",
          duration: 0.4,
          ease: "power2.out"
        });
  ...
  return (
    <div ref={container} className="min-h-screen bg-black text-white selection:bg-white/20 font-sans selection:text-white relative overflow-hidden">
      ...
      <section id="features" className="py-32 px-8 max-w-7xl mx-auto">
        <div className="section-header text-center space-y-4 mb-20">
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight">Integrate in minutes</h2>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            A simple, powerful interface designed to scale from small tanks to industrial facilities.
          </p>
        </div>
